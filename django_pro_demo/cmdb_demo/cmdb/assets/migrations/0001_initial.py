# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-01-15 19:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('networkdevice', '网络设备'), ('storagedevice', '存储设备'), ('securitydevice', '安全设备'), ('software', '软件资产')], max_length=64, verbose_name='资产类型')),
                ...
                ('purchase_day', models.DateField(blank=True, null=True, verbose_name='购买时间')),
                ('expire_day', models.DateField(blank=True, null=True, verbose_name='过保时间')),
                ...
                ('approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='approved_by', to=settings.AUTH_USER_MODEL, verbose_name='资产上线批准人')),
            ],
            options={
                'verbose_name': '资产总表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_num', models.DateField(blank=True, null=True, verbose_name='license数量')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slot', models.CharField(blank=True, max_length=64, null=True, verbose_name='所在槽位')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ram_size', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='内存大小')),
                ('cpu_model', models.CharField(blank=True, max_length=128, null=True, verbose_name='cpu型号')),
                ('cpu_count', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='物理cpu个数')),
                ('cpu_core_count', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='cpu核数')),
                ('os_distribution', models.CharField(blank=True, max_length=64, null=True, verbose_name='内测版')),
                ('os_type', models.CharField(blank=True, max_length=64, null=True, verbose_name='系统类型')),
                ('os_release', models.CharField(blank=True, max_length=64, null=True, verbose_name='系统发行版')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.SmallIntegerField(choices=[('auto', '自动添加'), ('manual', '手工录入')], default=0, verbose_name='添加方式')),
                ('model', models.CharField(blank=True, max_length=512, null=True, verbose_name='服务器型号')),
                ...
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset', verbose_name='资产类型')),
